...
async def txt_handler(client: Client, m: Message):
    await bot.send_message(m.chat.id, text= (
        f"🎉Congrats! You are using 𝗔𝗞𝗦𝗛𝗔𝗬:\n\n"
        ...
        f"**If you have any questions, feel free to ask [𝗔𝗞𝗦𝗛𝗔𝗬🐦](https://t.me/+MdZ2996M2G43MWl)! 💬**\n"
        )
    ) 
...
async def txt_handler(bot: Client, m: Message):
    ...
    if raw_text3 == '1':
        CR = '[𝄟⃝‌🐬Anonymous official🐬](https://t.me/+MdZ2996M2G43MWl)'
    else:
        CR = raw_text3
            ...
            try:
                ...
                if "drive" in url:
                    ...
                    Show = f"🚀𝐏𝐫𝐨𝐠𝐫𝐞𝐬𝐬 » {progress:.2f}%\n┃\n" \
                           ...
                           f"╰━✦𝐁𝐨𝐭 𝐌𝐚𝐝𝐞 𝐁𝐲 ✦ [𝗔𝗞𝗦𝗛𝗔𝗬🐦](https://t.me/+MdZ2996M2G43MWFl)"
